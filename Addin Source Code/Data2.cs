...
namespace TestAddin
{
    ...
    public class Data2
    {
        ...
        [ControlAttribution(swControlBitmapLabelType_e.swBitmapLabel_LinearDistance1)] //change icon
        [NumberBoxOptions(swNumberboxUnitType_e.swNumberBox_Length, 0, 1000, 0.01, false, 0.1, 0.001, swPropMgrPageNumberBoxStyle_e.swPropMgrPageNumberBoxStyle_Thumbwheel)]
        ...
        [ControlAttribution(swControlBitmapLabelType_e.swBitmapLabel_LinearDistance2)] // change icon
        [NumberBoxOptions(swNumberboxUnitType_e.swNumberBox_Length, 0, 1000, 0.01, false, 0.1, 0.001, swPropMgrPageNumberBoxStyle_e.swPropMgrPageNumberBoxStyle_Thumbwheel)]
